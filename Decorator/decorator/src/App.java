...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        DecoratorImpressora impressoraCopiadoraMono = new DecoratorImpressoraCopiadoraMono(impressoraMono);
        ...
        DecoratorImpressora impressoraCopiadoraColor = new DecoratorImpressoraCopiadoraColor(impressoraColor);
